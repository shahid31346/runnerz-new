...
class CompletedSingleD extends StatefulWidget {
  ...
  @override
  _CompletedSingleDState createState() => _CompletedSingleDState();
}

class _CompletedSingleDState extends State<CompletedSingleD> {
  String? _selection;
